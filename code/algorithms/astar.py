...
class A_Star():
    ...
    def __init__(self, connections, stations, max_duration, number_of_results=1):
                    ...
                    if self._number_of_results == 1:
                        ...
                        for connection in station.connections:
                            ...
                            if not start:
                                ...
                                line.add_connection(best_option.connections[0], self._max_duration, station1)
                                for old_connection in best_option.connections[1:]:
                                    line.add_connection(old_connection, self._max_duration)
                            
                            line.add_connection(connection, self._max_duration, starting_station)
